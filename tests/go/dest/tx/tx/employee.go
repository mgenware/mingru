...
// Insert ...
func (da *TableTypeEmployee) Insert(queryable dbx.Queryable, id int, firstName string, lastName string, gender string, birthDate time.Time, hireDate time.Time) (uint64, error) {
