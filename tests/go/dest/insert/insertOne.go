...
// InsertT ...
func (mrTable *TableTypeEmployee) InsertT(queryable mingru.Queryable, firstName string, lastName string, gender string, birthDate time.Time, hireDate time.Time) (uint64, error) {
