...
// InsertT ...
func (da *TableTypeEmployee) InsertT(queryable dbx.Queryable, firstName string, lastName string, gender string, birthDate time.Time, hireDate time.Time) (uint64, error) {
