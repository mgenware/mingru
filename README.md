...
func (da *TableTypeUser) SelectAllUserProfiles(queryable mingru.Queryable) ([]*UserTableSelectAllUserProfilesResult, error) {
...
// SelectSig ...
func (da *TableTypeUser) SelectSig(queryable mingru.Queryable, id uint64) (*string, error) {
	var result *string
...
// SelectUserProfile ...
func (da *TableTypeUser) SelectUserProfile(queryable mingru.Queryable, id uint64) (*UserTableSelectUserProfileResult, error) {
...
// UpdateUserProfile ...
func (da *TableTypeUser) UpdateUserProfile(queryable mingru.Queryable, id uint64, name string, sig *string) error {
